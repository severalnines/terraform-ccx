...
output "cluster_service_cidr" {
  ...
  value       = try(aws_eks_cluster.eks_cluster.kubernetes_network_config[0].service_ipv4_cidr, aws_eks_cluster.eks_cluster.kubernetes_network_config[0].service_ipv6_cidr, null)
}
